...
public class MavLink {
	...
	public static final int MSG_ID_OPTICAL_FLOW_RAD = 106;
	...
	public static final int MSG_ID_PARAM_MAP_RC = 50;
	public static final int MSG_ID_HOME_POSITION = 242;
	...
	public static final int MSG_ID_VTOL_STATE = 245;
	...
	public static final int MSG_ID_SCALED_PRESSURE2 = 137;
	...
	public static final int MSG_ID_MESSAGE_INTERVAL = 244;
	...
	public static final int MSG_ID_ATT_POS_MOCAP = 138;
	public static final int MSG_ID_CONTROL_SYSTEM_STATE = 146;
	...
	public static final int MSG_ID_CAMERA_TRIGGER = 112;
	public static final int MSG_ID_MISSION_WRITE_PARTIAL_LIST = 38;
	public static final int MSG_ID_SET_ACTUATOR_CONTROL_TARGET = 139;
	...
	public static final int MSG_ID_LANDING_TARGET = 149;
	...
	public static final int MSG_ID_ACTUATOR_CONTROL_TARGET = 140;
	...
	public static final int MSG_ID_VIBRATION = 241;
	...
	public static final int MSG_ID_SCALED_IMU3 = 129;
	...
	public static final int MSG_ID_TIMESYNC = 111;
	public static final int MSG_ID_SET_HOME_POSITION = 243;
	...
	public static final int MSG_ID_RESOURCE_REQUEST = 142;
	...
	public static final int MSG_ID_ALTITUDE = 141;
	...
	public static abstract class Message {
		...
		public static Message decodeMessage(byte[] bytes) {
			...
			switch(messageId) {
					...
					case MSG_ID_OPTICAL_FLOW_RAD: return new MSG_OPTICAL_FLOW_RAD (bytes);
					...
					case MSG_ID_PARAM_MAP_RC: return new MSG_PARAM_MAP_RC (bytes);
					case MSG_ID_HOME_POSITION: return new MSG_HOME_POSITION (bytes);
					...
					case MSG_ID_VTOL_STATE: return new MSG_VTOL_STATE (bytes);
					...
					case MSG_ID_SCALED_PRESSURE2: return new MSG_SCALED_PRESSURE2 (bytes);
					...
					case MSG_ID_MESSAGE_INTERVAL: return new MSG_MESSAGE_INTERVAL (bytes);
					...
					case MSG_ID_ATT_POS_MOCAP: return new MSG_ATT_POS_MOCAP (bytes);
					case MSG_ID_CONTROL_SYSTEM_STATE: return new MSG_CONTROL_SYSTEM_STATE (bytes);
					...
					case MSG_ID_CAMERA_TRIGGER: return new MSG_CAMERA_TRIGGER (bytes);
					case MSG_ID_MISSION_WRITE_PARTIAL_LIST: return new MSG_MISSION_WRITE_PARTIAL_LIST (bytes);
					case MSG_ID_SET_ACTUATOR_CONTROL_TARGET: return new MSG_SET_ACTUATOR_CONTROL_TARGET (bytes);
					...
					case MSG_ID_LANDING_TARGET: return new MSG_LANDING_TARGET (bytes);
					...
					case MSG_ID_ACTUATOR_CONTROL_TARGET: return new MSG_ACTUATOR_CONTROL_TARGET (bytes);
					...
					case MSG_ID_VIBRATION: return new MSG_VIBRATION (bytes);
					...
					case MSG_ID_SCALED_IMU3: return new MSG_SCALED_IMU3 (bytes);
					...
					case MSG_ID_TIMESYNC: return new MSG_TIMESYNC (bytes);
					case MSG_ID_SET_HOME_POSITION: return new MSG_SET_HOME_POSITION (bytes);
					...
					case MSG_ID_RESOURCE_REQUEST: return new MSG_RESOURCE_REQUEST (bytes);
					...
					case MSG_ID_ALTITUDE: return new MSG_ALTITUDE (bytes);
	...
	public static class MSG_HOME_POSITION extends Message {
		...
		public MSG_HOME_POSITION (short systemId, short componentId, int latitude  , int longitude  , int altitude  , float x  , float y  , float z  , float q [] , float approach_x  , float approach_y  , float approach_z  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MSG_VTOL_STATE extends Message {
	
		private int state; // The VTOL state the MAV is in
	
		public MSG_VTOL_STATE (byte[] bytes) {
			super(bytes);
		}
	
		public MSG_VTOL_STATE (short systemId, short componentId, int state  ) {
			super(systemId, componentId);
			this.state = state;
		}
	...
	public static class MSG_MESSAGE_INTERVAL extends Message {
		...
		public MSG_MESSAGE_INTERVAL (short systemId, short componentId, int interval_us  , int message_id  ) {
			super(systemId, componentId);
	...
	public static class MSG_CONTROL_SYSTEM_STATE extends Message {
		...
		public MSG_CONTROL_SYSTEM_STATE (short systemId, short componentId, long time_usec  , float x_acc  , float y_acc  , float z_acc  , float x_vel  , float y_vel  , float z_vel  , float x_pos  , float y_pos  , float z_pos  , float airspeed  , float vel_variance [] , float pos_variance [] , float q [] , float roll_rate  , float pitch_rate  , float yaw_rate  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
			this.x_acc = x_acc;
			this.y_acc = y_acc;
	...
	public static class MSG_LANDING_TARGET extends Message {
		...
		public MSG_LANDING_TARGET (short systemId, short componentId, long time_usec  , float angle_x  , float angle_y  , float distance  , float size_x  , float size_y  , int target_num  , int frame  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
	...
	public static class MSG_VIBRATION extends Message {
		...
		public MSG_VIBRATION (short systemId, short componentId, long time_usec  , float vibration_x  , float vibration_y  , float vibration_z  , long clipping_0  , long clipping_1  , long clipping_2  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
	...
	public static class MSG_SET_HOME_POSITION extends Message {
		...
		public MSG_SET_HOME_POSITION (short systemId, short componentId, int latitude  , int longitude  , int altitude  , float x  , float y  , float z  , float q [] , float approach_x  , float approach_y  , float approach_z  , int target_system  ) {
			super(systemId, componentId);
			this.latitude = latitude;
			this.longitude = longitude;
			this.altitude = altitude;
	...
	public static class MSG_RESOURCE_REQUEST extends Message {
		...
		public MSG_RESOURCE_REQUEST (short systemId, short componentId, int request_id  , int uri_type  , int uri [] , int transfer_type  , int storage [] ) {
			super(systemId, componentId);
	...
	public static class MSG_ALTITUDE extends Message {
		...
		public MSG_ALTITUDE (short systemId, short componentId, float altitude_monotonic  , float altitude_amsl  , float altitude_local  , float altitude_relative  , float altitude_terrain  , float bottom_clearance  ) {
			super(systemId, componentId);
